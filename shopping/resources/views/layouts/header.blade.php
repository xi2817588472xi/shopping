...
<title>美国站</title> 
<meta name="keywords" content="美国站" />
...
<link rel="stylesheet" rev="stylesheet" href="/index/css/usa.css" type="text/css" media="screen">
    ...
    <div class="content">
        ...
        <div class="top mobile_none">
            <div class="clear w90" id="top">
                ...
                <div class="fr">
                    <div class="fl"><a href="/home/login">
                    <?php
              if(empty($_SESSION['username'])){
                echo "登录";
               }else{
                echo "<a href='/home/information'>".$_SESSION['username']."</a>"."<a href='/home/exit'>|退出</a>";
               }
            ?></a></div>
        ...
        <div class="header ">
            <div class="clear w90" id="header">
                ...
                <div class="header_l mobile_none"><a href="index.html"><img src="/index/images/logo.png"></a></div>
                <!--搜索-->
            ...
            <div class="w90">
                <div class="clear nav_text">
                    <div class="nav_l">
                        ...
                        <a href="usa.html" class="on">美国站</a>
                        <a href="usa.html" >日本站</a>
                        <a href="usa.html" >澳洲站</a> 
                        <a href="usa.html" >德国站</a>
                        <a href="usa.html" >韩国站</a>
                        <a href="/home/whole" >全球精选</a>
                    </div>
                    <!--<div class="nav_r">
